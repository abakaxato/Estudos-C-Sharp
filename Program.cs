...
namespace OlaMundo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Account upConta3 = new SavingAccount(54,"Fernando",7000,0.1);
                ...
                //Validando antes de converter
            {
                ...
                if (upConta3 is SavingAccount) // Convertendo com o tipo correto
                {
                    SavingAccount downConta2 = (SavingAccount)upConta3;
                    //Poderia ser assim :
